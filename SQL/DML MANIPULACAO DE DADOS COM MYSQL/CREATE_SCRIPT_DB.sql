...
-- Schema vendas_sucos
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `vendas_sucos` DEFAULT CHARACTER SET utf8 ;
USE `vendas_sucos` ;
...
CREATE TABLE IF NOT EXISTS `vendas_sucos`.`produtos` (
  ...
  `SBAOR` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `vendas_sucos`.`tabela_itens_notas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `vendas_sucos`.`tabela_itens_notas` (
  `NUMERO` VARCHAR(5) NOT NULL,
  `CODIGO` VARCHAR(10) NOT NULL,
  `QUANTIDADE` INT NULL DEFAULT NULL,
  `PRECO` FLOAT NULL DEFAULT NULL,
  PRIMARY KEY (`NUMERO`, `CODIGO`),
  INDEX `FK_CODIGO` (`CODIGO` ASC) VISIBLE,
